        ...
        >
            <div className="flex items-start">
                <div className="flex-shrink-0">
                    {variant === 'success' && (
                        <svg
                            className={`h-5 w-5 ${variantIconColors[variant]}`}
                            fill="currentColor"
                            viewBox="0 0 20 20"
                        >
                            <path
                ...
                {onClose && (
                    <div className="ml-auto pl-3">
                        <div className="-mx-1.5 -my-1.5">
                            <button
                                type="button"
                                className={`inline-flex rounded-md p-1.5 ${variantIconColors[variant]} hover:bg-opacity-10 focus:outline-none focus:ring-2 focus:ring-offset-2`}
                                onClick={onClose}
                            >
